      ...
      {type === "certify" && (
        <g>
          ...
          <rect
            ...
            height="40"
            rx="3"
            className={light ? "fill-zinc-50 stroke-indigo-300" : "fill-white/5 stroke-white/40"}
            strokeWidth="1.5"
          />
          <path
            d="M60 82 L68 90 L84 72"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            className={light ? "text-indigo-500" : "text-white/80"}
        ...
        <g>
          ...
          {animate && (
            <motion.circle
              r="2.5"
              className={light ? "fill-indigo-500" : "fill-white"}
              animate={{ cx: [96, 136, 176], cy: [68, 68, 68] }}
