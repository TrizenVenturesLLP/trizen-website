...
const Ventures = () => {
  return (
    <>
        {/* Hero Section */}
        <section className="relative py-20 md:py-28 bg-white border-b border-zinc-200 overflow-hidden">
          <div
            className="pointer-events-none absolute left-1/2 top-0 h-[360px] w-[560px] -translate-x-1/2 rounded-full bg-indigo-500/10 blur-[100px]"
            aria-hidden
          />
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 p-2 px-3 bg-indigo-50 rounded-lg text-indigo-700 mb-6 border border-indigo-100">
                <Rocket className="w-5 h-5" />
                <span className="text-sm font-medium">Trizen Ventures</span>
              </div>
              
              <h1 className="text-4xl md:text-6xl font-bold text-zinc-900 mb-6 leading-tight tracking-[-0.03em]">
                Fueling Tomorrow&apos;s Disruptors
              </h1>
              
              <p className="text-lg md:text-xl text-zinc-600 mb-8 max-w-3xl mx-auto">
                ...
                <Card className="bg-gradient-to-br from-white to-indigo-50 border border-indigo-100">
                  <CardContent className="pt-8 px-6 text-center">
                    <div className="bg-indigo-100 p-4 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <Lightbulb className="h-8 w-8 text-indigo-700" />
                    </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="mt-12 p-8 bg-indigo-50 rounded-xl border border-indigo-100">
                <div className="flex flex-col md:flex-row gap-8">
                  ...
                  <div className="md:w-1/3 bg-white rounded-lg p-6 border border-indigo-100 flex items-center justify-center">
                    <div className="text-center">
                      <div className="text-5xl font-bold text-indigo-700 mb-2">$12M</div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="relative max-w-4xl mx-auto">
                {/* Timeline line */}
                <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-0.5 bg-indigo-200 transform md:translate-x-px"></div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="mt-8 p-6 bg-indigo-600 text-white rounded-xl text-center">
                ...
                <Button variant="outline" className="bg-white text-indigo-700 hover:bg-white/90">
        ...
        {/* Pitch to Trizen */}
        <section className="py-16 bg-indigo-50 text-zinc-900 border-y border-indigo-100">
          <div className="container mx-auto px-4">
            <motion.div 
              initial="hidden"
              whileInView="visible"
              ...
              <Card className="bg-white text-slate-900 p-8 mb-6">
                <CardContent className="p-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                    <div>
                      <div className="font-semibold mb-2 text-indigo-800">Strong Vision</div>
                    ...
                    <div>
                      <div className="font-semibold mb-2 text-indigo-800">Product-Market Fit</div>
                      <p className="text-slate-600 text-sm">
                    ...
                    <div>
                      <div className="font-semibold mb-2 text-indigo-800">Exceptional Team</div>
                      <p className="text-slate-600 text-sm">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="pt-6">
                    <div className="text-sm text-indigo-600 font-medium mb-2">June 15, 2025</div>
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="pt-6">
                    <div className="text-sm text-indigo-600 font-medium mb-2">August 10, 2025</div>
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="pt-6">
                    <div className="text-sm text-indigo-600 font-medium mb-2">September 5, 2025</div>
...
const FocusAreaCard = ({ icon, title, description }) => {
  return (
    <motion.div
      ...
      className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-md hover:border-indigo-200 transition-all duration-300"
    >
      <div className="bg-indigo-100 p-4 rounded-full w-16 h-16 flex items-center justify-center mb-4">
        {icon}
      </div>
