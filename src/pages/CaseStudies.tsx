...
const CaseStudies = () => {
  ...
  return (
    <ListingPage
      ...
      heading="Outcomes that move the operating model"
      intro="Each engagement is documented as challenge, solution, stack, impact, and KPIs your leadership team can fund."
      bodyClassName="bg-zinc-50"
      cta={{
        title: "Want results like these?",
        description:
          "Book a consultation to map outcomes, readiness, and a delivery path your leadership team can fund.",
